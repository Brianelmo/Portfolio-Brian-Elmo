...
function Education() {
  return (
    <div
      id="Resume"
      className="mt-40 mb-20 pt-16 pb-16 bg-gray-100 flex flex-col items-center font-poppins lg:ml-60"
    >
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 place-items-center gap-4 mb-24">
        ...
        <Card
          ...
          title={"Java"}
          description={
            "Training in development using Java as the main language and Mysql as a database."
          }
          school={"Oracle Next Education"}
        ></Card>
        <Card
          ...
          title={"Git"}
          school={"Oracle Next Education"}
          description={"Training in the version control tool Git."}
        ></Card>
        <Card
          year={"2022-2023"}
          title={"Programming bases"}
          description={
            "Course where you learn programming logic, programming paradigms and design patterns."
          }
          school={"Oracle Next Education"}
        ></Card>
      </div>
      ...
      <div className="grid gap-x-4 grid-cols-1 md:grid-cols-2 md:gap-x-60 text-5xl mb-20 mt-16">
        ...
        <div className="flex flex-col text-center gap-2 mb-20">
          <i class="fa-brands fa-square-js  text-yellow-200"></i>
          <p>JavaScript</p>
        </div>
        <div className="flex flex-col text-center gap-2 mb-20">
          <i class="fa-brands fa-react  text-blue-500"></i>
          <p>ReactJS</p>
        </div>
        <div className="flex flex-col text-center gap-2 mb-20">
          <i class="fa-solid fa-code-branch  text-orange-500"></i>
          <p>GIT</p>
        </div>
        <div className="flex flex-col text-center gap-2 mb-20">
          <i class="fa-brands fa-node-js text-green-700"></i>
          <p>NODEJS</p>
        </div>
      </div>
